...
int main(int argc, int * argv[]){
  ...
  int tPaper = 0;
  Edge etest[50000];
  //vector<int> teV[18000];
  //vector<int> teV2[18000];
  //vector<int> teV3[18000];
  //vector<int> teV4[18000];
  cout << "StratRead" << endl;
  system("pause");
  return 0;
  ...
  while (infile >> tAuthor1){
    ...
    infile >> tConf;
    infile >> tPaper;
    Graph[tAuthor1][tAuthor2].calWeight(tYear, tConf, tPaper);
    Graph[tAuthor2][tAuthor1].calWeight(tYear, tConf, tPaper);
  }
